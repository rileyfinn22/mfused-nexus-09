...
BEGIN
  ...
  IF v_has_children AND v_blanket_closed THEN
    -- Closed blanket: subtotal = actual shipped work (Σ shipped × price), NOT Σ children.
    -- Children only reflect what has been invoiced; the closed blanket must reflect
    -- what actually shipped so any unpaid remainder shows as balance due.
