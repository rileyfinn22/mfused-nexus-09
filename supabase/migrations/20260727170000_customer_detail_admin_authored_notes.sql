-- Customers see production notes/attachments ONLY when a vibe admin posted
-- them (created_by has the vibe_admin role). Vendor-authored notes and all
-- vendor doc slots stay admin-only. Applied live via claude-admin.
