        ...
        <div style={{ flex: 1, minWidth: 320 }}>
          ...
          <div style={{ display: "flex", gap: 10, marginTop: 30, flexWrap: "wrap" }}>
            {["Live Progress", "Stage Details", "Timeline View", "Delivery ETA"].map((pill, i) => {
              ...
              return (
                <div key={pill} style={{ padding: "8px 18px", borderRadius: 20, background: "rgba(59,130,246,0.15)", border: "1px solid rgba(59,130,246,0.3)", color: "#60a5fa", fontSize: 15, fontWeight: 600, fontFamily: "sans-serif", opacity: pillSpring, transform: `translateY(${interpolate(pillSpring, [0, 1], [15, 0])}px)` }}>{pill}</div>
              );
            })}
          </div>
        </div>
