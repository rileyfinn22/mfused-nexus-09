...
>(({ className, ...props }, ref) => (
  <div className="relative w-full overflow-auto scrollbar-thin rounded-xl border border-border bg-card shadow-sm">
    <table
      ref={ref}
...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn(
      "border-t-2 bg-muted font-medium [&>tr]:last:border-b-0",
      className
    )}
    {...props}
  />
